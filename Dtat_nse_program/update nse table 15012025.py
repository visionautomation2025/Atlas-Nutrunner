...
class NiftyApp:
    ...
    def setup_ui(self):
        ...
        # CE Treeview
        self.ce_tree = CustomTreeview(ce_frame, columns=columns, show="headings", height=10)  # Height set to 10
        ...
        # PE Treeview
        self.pe_tree = CustomTreeview(pe_frame, columns=columns, show="headings", height=10)  # Height set to 10
