...
class NiftyApp:
    def __init__(self, root):
        ...
        self.root.geometry("1600x600")  # Increased width for new columns
        self.nifty_client = NiftyOptionChain()
        self.db = Database()  # SQLite Database
        self.setup_ui()
        ...
        try:
            ...
            for strike in relevant_strikes:
                ...
                if "CE" in item:
                    ...
                    self.db.insert_data(strike, ce_data.get("openInterest", 0), 
                                        ce_data.get("changeinOpenInterest", 0),
                                        ce_data.get("totalTradedVolume", 0),
                                        ce_data.get("lastPrice", 0),
                                        change_value, "CE")
                ...
                if "PE" in item:
                    ...
                    # Insert into database
                    self.db.insert_data(strike, pe_data.get("openInterest", 0), 
                                        pe_data.get("changeinOpenInterest", 0),
                                        pe_data.get("totalTradedVolume", 0),
                                        pe_data.get("lastPrice", 0),
                                        change_value, "PE")
